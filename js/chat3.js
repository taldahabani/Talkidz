...
const firstMessages = {
  ...
  monkey: {
    ...
    shaky: {
    en: "Hello, I'm Professor Shaky! Nice to meet you!",
    ja: "こんにちは、シェイキー教授です！お会いできて嬉しいです！",
    zh: "你好，我是抖抖教授！很高兴见到你！",
    de: "Hallo, ich bin Professor Shaky! Schön dich kennenzulernen!",
    hi: "नमस्ते, मैं प्रोफेसर शेकी हूं! आपसे मिलकर खुशी हुई!",
    fr: "Bonjour, je suis le Professeur Shaky ! Ravi de vous rencontrer !",
    ko: "안녕하세요, 저는 쉐이키 교수예요! 만나서 반갑습니다!",
    pt: "Olá, eu sou o Professor Shaky! Prazer em conhecê-lo!",
    it: "Ciao, sono il Professor Shaky! Piacere di conoscerti!",
    es: "¡Hola, soy el Profesor Shaky! ¡Encantado de conocerte!",
    id: "Halo, saya Profesor Shaky! Senang berkenalan dengan Anda!",
    nl: "Hallo, ik ben Professor Shaky! Aangenaam kennis te maken!",
    tr: "Merhaba, ben Profesör Shaky! Tanıştığımıza memnun oldum!",
    fil: "Hello, ako si Professor Shaky! Ikinagagalak kitang makilala!",
    pl: "Witaj, jestem Profesor Shaky! Miło cię poznać!",
    sv: "Hej, jag är Professor Shaky! Trevligt att träffas!",
    bg: "Здравейте, аз съм Професор Шейки! Приятно ми е да се запознаем!",
    ro: "Bună, sunt Profesorul Shaky! Încântat să te cunosc!",
    ar: "مرحباً، أنا البروفيسور شيكي! سعيد بلقائك!",
    cs: "Dobrý den, jsem Profesor Shaky! Těší mě!",
    el: "Γεια σας, είμαι ο Καθηγητής Σέικι! Χαίρω πολύ!",
    fi: "Hei, olen Professori Shaky! Hauska tutustua!",
    hr: "Pozdrav, ja sam Profesor Shaky! Drago mi je upoznati vas!",
    ms: "Hai, saya Profesor Shaky! Gembira berkenalan dengan anda!",
    sk: "Dobrý deň, som Profesor Shaky! Teší ma!",
    da: "Hej, jeg er Professor Shaky! Dejligt at møde dig!",
    ta: "வணக்கம், நான் பேராசிரியர் ஷேக்கி! உங்களை சந்தித்ததில் மகிழ்ச்சி!",
    uk: "Вітаю, я Професор Шейкі! Радий знайомству!",
    ru: "Здравствуйте, я Профессор Шейки! Рад знакомству!"
},
  cupcake: {
